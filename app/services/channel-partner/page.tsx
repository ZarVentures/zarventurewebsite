        ...
        <section className="relative overflow-hidden py-24">
          ...
          <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-5xl mx-auto text-center">
              <span className="inline-flex items-center px-4 py-1 rounded-full bg-white/10 border border-white/20 text-white text-sm mb-6 backdrop-blur-md">
              ...
              <div className="relative h-[350px] md:h-[500px] rounded-[32px] overflow-hidden shadow-2xl border border-white/10">
                <Image 
                  ...
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-300 mt-2">
                        Result-oriented support from our organization.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="space-y-20 max-w-6xl mx-auto">
              {content.sections.map((section, index) => {
                ...
                return (
                  <div key={section.id} className={`grid lg:grid-cols-2 gap-10 items-center ${!isEven ? 'lg:flex-row-reverse' : ''}`}>
                    {/* IMAGE */}
